...
%   Handbook, Third Edition, 1998, CRC Press: Flower, Blood, Circuit, Rice,
%   Saturn, Bone Marrow, and Aluminum.
%
%   See also IMNOISE, MEDFILT2, ORDFILT2, WIENER2.

%   Copyright 1993-2002 The MathWorks, Inc.  
%   $Revision: 1.15 $  $Date: 2002/04/04 18:03:29 $
...
ud.hImgPop = uicontrol(Menu, ...
   ...
   'String','Flower|Blood|Circuit|Rice|Pout|Saturn|Quarter|Bone Marrow|Aluminum', ...
...
switch name
case 'Blood'
   blood = [];          % Hint for the parser to avoid confusing it when load
   load imdemos blood % creates a new variable.
   img = blood;
case 'Saturn',
   saturn = [];
   load imdemos saturn
