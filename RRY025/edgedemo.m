...
%   Handbook, Third Edition, 1998, CRC Press: Blood, Circuit, Aluminum, 
%   Rice, Saturn, and Bone Marrow.
%  
%   See also EDGE.

%   Copyright 1993-2002 The MathWorks, Inc.  
%   $Revision: 1.19 $  $Date: 2002/04/04 18:03:34 $
...
hdl.ImgPop=uicontrol(Std, ...
   ...
   'Enable','on', ...
   'String','Blood|Circuit|Aluminum|Rice|Saturn|Eight Bit|Bone Marrow', ...
   'Tag','ImagesPop',...
