...
%   Handbook, Third Edition, 1998, CRC Press: Vertigo, Rectangles, Saturn, 
%   Flower, and Bone Marrow.
%  
%   See also FREQZ2, FSAMP2, FTRANS2, FWIND1, FWIND2.

%   Copyright 1993-2002 The MathWorks, Inc.  
%   $Revision: 1.19 $  $Date: 2002/04/04 18:03:40 $
...
hdl.ImgPop=uicontrol('Parent', FirDemoFig, ...
   ...
   'Position',btnPos, ...
   'Enable','on', ...
   'String','Vertigo|Rectangles|Saturn|Flower|Quarter|Bone Marrow', ...
   'Tag','ImagesPop',...
